...
# Agregar la terminación "*.pdf" a los documentos generados de manera automática, porque si se le olvida al usuario ponerla, se creará un archivo de ningún tipo.
# la función browse() me puede servir para el programa de imágenes que voy a hacer.
# La interfaz me puede servir para el programa de imágenes.
...
Button(frame, image=Button_icon, width=35, height=24, bg="#d3cdcd", command=browse, cursor="hand2").place(x=500, y=47)

##########################
target = StringVar()
Label(frame, text="Target PDF File:", font="arial 10 bold", fg="#4c4542").place(x=30, y=100)
entry2 = Entry(frame, width=30, textvariable=target, font="arial 15", bd=1) # Agregar la terminación "*.pdf"
...
Protect = Button(root, text="Protect PDF File", compound=LEFT, image=button_icon, width=230, height=50, bg="#bfb9b9", font="arial 14 bold", command=Protect, cursor="hand2")
