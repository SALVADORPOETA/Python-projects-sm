...
# Arreglar imágenes para que no se pierda su calidad al cambiar su tamaño.
...
def Send():
	...
	window.title("Send")
	window.geometry("450x560+880+60")
	...
	img = Image.open("Images/sender.png")
	resized_image = img.resize((455, 237))
	Sbackground = ImageTk.PhotoImage(resized_image)
...
def Receive():
	...
	img = Image.open("Images/receiver.png") 
	resized_image = img.resize((455, 237))
	Hbackground = ImageTk.PhotoImage(resized_image)
	...
	imageicon = ImageTk.PhotoImage(resized_image)
...
Label(root, image=background).place(x=-5, y=323)
