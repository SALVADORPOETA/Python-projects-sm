...
# Ampliar el cuadro de thpwd hacia la derecha.
# Mover el label de zona horaria hacia la izquierda.
# Mover el cuadro de hoy hacia la izquierda y ampliarlo hacia la derecha.
# Mover el label de los días hacia la izquierda y ampliarlo hacia abajo.
# Este código me puede servir para la mac-soft app.
# Probar el activebackground en el botón de buscar.
# Ampliar los label de la temperatura de los días hacia la derecha porque no caben las letras.
...
def getWeather():
	...
	# weather
	api = "https://api.openweathermap.org/data/2.5/onecall?lat="+str(location.latitude)+"&lon="+str(location.longitude)+"&units=metric&exclude=hourly&appid=b4072c59e7366eba4106be23b6cf5807"
