...
def weather():
	...
	def getWeather():
		try:
			...
			# weather
			api = "https://api.openweathermap.org/data/2.5/weather?q=" + city + "&appid=b4072c59e7366eba4106be23b6cf5807"
			...
			messagebox.showerror("Wheater App", "Invalid Entry")
	...
	Searh_icon = PhotoImage(file="Image/search_icon.png")
	myimage_icon = Button(app1, image=Searh_icon, borderwidth=0, cursor="hand2", bg="#404040", command=getWeather)
...
def calendar():
	...
	mycal = Calendar(app3, setmode="day", date_pattern="dd/mm/yy")
...
def game():
	app5 = Toplevel()
	app5.geometry("300x500+900+170")
	app5.title("Ludo")
	app5.configure(bg="#dee2e5")
	app5.resizable(False, False)

	# icon 
	image_icon = PhotoImage(file="Image/ludo back.png")
...
def close_apps():
	wb.register("chrome", None)
	wb.open("https://www.youtube.com/watch?v=yJ1C2eVQWW8&t=1941s")
...
apps = Label(RHB, text="Apps", font=("Acumin Variable Cocept", 15), bg="#f4f5f5")
