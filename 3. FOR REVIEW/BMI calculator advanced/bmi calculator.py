...
# Agregarle el cálculo para mujeres también.
# Agregarle una imágen de una mujer.
...
Button(root, text="View Report", width=15, height=2, font="arial 10 bold", bg="#1f6e68", fg="white", command=BMI, cursor="hand2", activebackground="#1f6e68").place(x=330, y=340)
