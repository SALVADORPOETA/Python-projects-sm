...
# check button
checkValue = IntVar
checkbtn = Checkbutton(text="Remember me?", variable=checkValue, cursor="hand2")
checkbtn.place(x=200, y=340)

Button(text="Register", font=20, width=11, height=2, command=register, cursor="hand2").place(x=250, y=380)
