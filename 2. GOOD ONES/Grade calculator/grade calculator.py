...
Button(text="Calculate", font="arial 15", bg="white", bd=10, cursor="hand2", command=Calculation).place(x=50, y=300)
Button(text="Exit", font="arial 15", bg="white", bd=10, width=8, cursor="hand2", command=lambda:exit()).place(x=350, y=300)
