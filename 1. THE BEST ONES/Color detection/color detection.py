...
# color1
colors = Canvas(frame, bg="#fff", width=150, height=255, bd=0)
colors.place(x=20, y=100)

id1 = colors.create_rectangle((10, 10, 50, 57), fill="#b8255f")
id2 = colors.create_rectangle((10, 57, 50, 104), fill="#db4035")
id3 = colors.create_rectangle((10, 104, 50, 151), fill="#ff9933")
id4 = colors.create_rectangle((10, 151, 50, 198), fill="#fad000")
id5 = colors.create_rectangle((10, 198, 50, 245), fill="#afb83b")


hex1 = Label(colors, text="#fad000", fg="#000", font="arial 12 bold", bg="white")
hex1.place(x=60, y=10+10)

hex2 = Label(colors, text="#b8255f", fg="#000", font="arial 12 bold", bg="white")
hex2.place(x=60, y=10+57)

hex3 = Label(colors, text="#db4035", fg="#000", font="arial 12 bold", bg="white")
hex3.place(x=60, y=10+104)

hex4 = Label(colors, text="#ff9933", fg="#000", font="arial 12 bold", bg="white")
hex4.place(x=60, y=10+151)

hex5 = Label(colors, text="#afb83b", fg="#000", font="arial 12 bold", bg="white")
hex5.place(x=60, y=10+198)


# color2
colors2 = Canvas(frame, bg="#fff", width=150, height=255, bd=0)
colors2.place(x=180, y=100)

id6 = colors2.create_rectangle((10, 10, 50, 57), fill="#7ecc49")
id7 = colors2.create_rectangle((10, 57, 50, 104), fill="#299438")
id8 = colors2.create_rectangle((10, 104, 50, 151), fill="#6accbc")
id9 = colors2.create_rectangle((10, 151, 50, 198), fill="#158fad")
id10 = colors2.create_rectangle((10, 198, 50, 245), fill="#14aaf5")


hex6 = Label(colors2, text="#158fad", fg="#000", font="arial 12 bold", bg="white")
hex6.place(x=60, y=10+10)

hex7 = Label(colors2, text="#7ecc49", fg="#000", font="arial 12 bold", bg="white")
hex7.place(x=60, y=10+57)

hex8 = Label(colors2, text="#299438", fg="#000", font="arial 12 bold", bg="white")
hex8.place(x=60, y=10+104)

hex9 = Label(colors2, text="#6accbc", fg="#000", font="arial 12 bold", bg="white")
hex9.place(x=60, y=10+151)

hex10 = Label(colors2, text="#14aaf5", fg="#000", font="arial 12 bold", bg="white")
hex10.place(x=60, y=10+198)
